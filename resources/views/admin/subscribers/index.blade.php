...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <div class="white-box">
                <h3 class="box-title m-b-0">Kelola Subscriber</h3>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div id="edit-modal{{ $value->id }}" class="modal fade" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <form method="post" action="{{ url('subscribers/' . $value->id) }}"
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-warning">
                                                                ...
                                                                <h4 class="modal-title">Edit Subscribers</h4>
                                                            </div>
                                            ...
                                            {{-- HAPUS --}}
                                            <button onclick="document.getElementById('delete{{ $value->id }}').submit();"
                                                class="btn btn-danger" href="#"><i class="fa fa-trash"></i></button>

                                            <form id="delete{{ $value->id }}"
                                                action="{{ url('subscribers/' . $value['id']) }}" method="post">
                                                @csrf
