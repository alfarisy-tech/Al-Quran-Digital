...
<head>
    ...
    <title>Maktab - The Islamic Center 5 Template</title>
    ...
    <link rel="stylesheet" href="{{ asset('/assets/css/perfect-scrollbar.cs') }}s">
...
<body>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-lg-6">
                                <div class="form-group row mb-0">
                                    <div class="col-md-12">
                                        <h6 class="mb-0">
                                            <p>Already have an account ? <a class="link" href="{{ route('login') }}">
                                                    Click Here
                                                </a>
                                            </p>
                                        </h6>
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group row mb-0">
                                        <div class="col-md-6 offset-md-4">
                                            <button class="thm-btn thm-bg" type="submit">Register
    ...
    <script src="{{ asset('/assets/js/jquery.bootstrap-touchspin.min.j') }}s"></script>
    ...
    <script src="{{ asset('/assets/js/custom-scripts.j') }}s"></script>
</body>
